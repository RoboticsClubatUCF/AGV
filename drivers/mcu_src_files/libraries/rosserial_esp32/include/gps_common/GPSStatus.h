...
namespace gps_common
{
  ...
  class GPSStatus : public ros::Msg
  {
    ...
    GPSStatus():
      header(),
      satellites_used(0),
      satellite_used_prn_length(0), st_satellite_used_prn(), satellite_used_prn(nullptr),
      satellites_visible(0),
      satellite_visible_prn_length(0), st_satellite_visible_prn(), satellite_visible_prn(nullptr),
      satellite_visible_z_length(0), st_satellite_visible_z(), satellite_visible_z(nullptr),
      satellite_visible_azimuth_length(0), st_satellite_visible_azimuth(), satellite_visible_azimuth(nullptr),
      satellite_visible_snr_length(0), st_satellite_visible_snr(), satellite_visible_snr(nullptr),
      status(0),
      motion_source(0),
    ...
    virtual const char * getType() override { return "gps_common/GPSStatus"; };
    virtual const char * getMD5() override { return "313baa8951fdd056c78bf61b1b07d249"; };
